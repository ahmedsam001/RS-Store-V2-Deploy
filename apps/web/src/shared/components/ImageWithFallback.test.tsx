...
describe('ImageWithFallback', () => {
  it('shows fallback when src is empty', () => {
    ...
    expect(document.querySelector('.rs-image-with-fallback-subcategory')).toHaveAttribute('title', 'Subcategory image coming soon');
  });
  ...
  it('shows image when src is valid URL', () => {
    renderWithRouter(<ImageWithFallback src="https://example.com/image.jpg" alt="Test image" fallbackVariant="subcategory" />);
